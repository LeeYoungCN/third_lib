...
if (NOT CMAKE_PRESET)
    if (${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
        ...
        elseif (MINGW)
            set(CMAKE_PRESET "MinGW_${CMAKE_BUILD_TYPE}")
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
            set(CMAKE_PRESET "Clang_MSVC_${CMAKE_BUILD_TYPE}")
        else()
    ...
    elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Darwin")
        if (CMAKE_COMPILER_IS_GNUCC)
            set(CMAKE_PRESET "${CMAKE_SYSTEM_NAME}_GNU_${CMAKE_BUILD_TYPE}")
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
            set(CMAKE_PRESET "${CMAKE_SYSTEM_NAME}_Clang_${CMAKE_BUILD_TYPE}")
        else()
            message(WARNNING "Unknown compiler: ${CMAKE_CXX_COMPILER_ID}")
        endif()
    else()
